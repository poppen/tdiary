# ja/recent_comment3.rb $Revision: 1.4 $
#
...
if @mode == 'conf' || @mode == 'saveconf'
   add_conf_proc( 'recent_comment3', '最近のツッコミ', 'tsukkomi' ) do
      ...
      <p>最大 <input name="recent_comment3.max" value="#{@conf['recent_comment3.max']}" size="3" /> 件</p>
      ...
      <p>最大 <input name="recent_comment3.titlelen" value="#{@conf['recent_comment3.titlelen']}" size="3" /> 文字</p>
