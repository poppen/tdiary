...
\" width=\"16\" height=\"12\" style =\"border: none;\" alt=\"#{@caption_hatena}\" title=\"#{@caption_hatena}\" /></a> |
      ...
      if @conf['add.bookmark.del'] == "t" then
         caption += %Q|<a href=\"http://del.icio.us/1?url=#{@conf.base_url}#{anchor date.strftime('%Y%m%d')}%23p#{'%02d' % index}\"><img src=\"http://del.icio.us/img/delicious.gif\" width=\"18\" height=\"18\" style=\"border: none;\" alt=\"#{@caption_del}\" title=\"#{@caption_del}\" /></a> |
      end
      
      if @conf['add.bookmark.mm'] == "t" then
         caption += %Q|<a href=\"http://1470.net/mm/memo_form.html?url=#{@conf.base_url}#{anchor date.strftime('%Y%m%d')}%23p#{'%02d' % index}\"><img src=\"http://1470.net/img/mm_icon.gif\" width=\"21\" height=\"12\" style=\"border: none;\" alt=\"#{@caption_mm}\" title=\"#{@caption_mm}\" /></a> |
      end
   end
