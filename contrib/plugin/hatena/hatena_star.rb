...
add_header_proc do
	...
	hatena_star << %Q|\t<script type="text/javascript"><!--\n|
		@hatena_star_options.each do |o,v|
			hatena_star << %Q|\t\tHatena.Star.#{v} = '#{h @conf["hatena_star.#{o}"]}';\n| if @conf["hatena_star.#{o}"]
		end
...
add_conf_proc( 'hatena_star', 'Hatena::Star' ) do
	...
	<<-HTML
	<h3>Token</h3>
	<p><input name="hatena_star.token" value="#{h @conf['hatena_star.token']}" size=50></P>
	<h3>Star Image (URL)</h3>
	<p><input name="hatena_star.star.image" value="#{h @conf['hatena_star.star.image']}" size=50></P>
	<h3>Add Star Image (URL)</h3>
	<p><input name="hatena_star.star.add" value="#{h @conf['hatena_star.star.add']}" size=50></P>
	<h3>Comment Image (URL)</h3>
	<p><input name="hatena_star.comment.image" value="#{h @conf['hatena_star.comment.image']}" size=50></P>
	<h3>Active Comment Image (URL)</h3>
	<p><input name="hatena_star.comment.active" value="#{h @conf['hatena_star.comment.active']}" size=50></P>
	HTML
end
